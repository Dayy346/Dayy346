...
<table style="width: 100%; border-collapse: collapse;">
  <thead>
    <tr style="background-color: #242238; color: white;">
      <th style="padding: 10px; text-align: left;">Languages</th>
      <th style="padding: 10px; text-align: left;">Frameworks & Libraries</th>
      <th style="padding: 10px; text-align: left;">Databases</th>
      <th style="padding: 10px; text-align: left;">Miscellaneous Tools & Technologies</th>
    </tr>
  </thead>
  <tbody>
    <tr>
